...
{% sectionCollection tag="div", class="flow space:--step--4" %}
...
{% link url="http://www.compagnie3637.be/contact/", type="external", class="button" %}Newsletter [TODO]{% endlink %}
{% endwrapper %}

{% image src="/_images/cie3637_les-de-uesobe-ueisseurs2_cre-uedit-marie-he-uele-cne-tercafs.webp", aspectRatio=3 %}
